...
<table class="table note">
    <tr>
        <td style="padding: 2px 12px;">
            <span class="notehead"><?php echo __('Note :If Samayojan process is completed for your sanstha, only then data can be extracted.'); ?></span> 
        </td>
<!--        <td>
...
<div style="width:100%;padding:5px;clear:both;">
            ...
            <div class="table-responsive">
                <table class="table b_table" id="rostertable" style="border-collapse:collapse;">
                    ...
                    <tr> 
                        ...
                        <td class="col-xs-1" style="text-align:center;"><input  type="submit" name="submit" id="roster_submit" value="Accept" class="btn btn-sm logbutton2"></td>
    ...
    <!--                    <td class="col-xs-2" colspan="2" style="text-align:center;">
        ...
        <div class="table-responsive" style="margin-top:5px;">
            <table class="table table_extract" border="0" style="width:80%; background:#fff">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr style="cursor: pointer;" class="Subjectdtl" id="<?php //echo $post['SubjectTaught']['id'];                                                                                                                                                                                                               ?>">
                        <td class="col-xs-1"  height="22">6</td>
