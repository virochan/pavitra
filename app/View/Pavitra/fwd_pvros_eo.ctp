...
//                    $('#SamayojanVacntSum').val('0');
        ...
        $("#roster_fwd_eo").click(function () {
            ...
            if(img=='undefined' || img==''){
                alert('Please Upload Certificate for Roster');
             return false;
            }
...
//                                        alert("Roster data already forwarded");
//                                        $("input").prop('disabled', true);
                                        $("#roster_fwd_eo").prop('disabled', false);
                                        $("#caste_hm_exit").prop('disabled', false);
                                    }
                                ...
                                if (key === 'roster_file_name') {
                                    if(val===null || val===''){
                                        alert('Please upload roster certificate before forwarding the data');
...
<?php echo $this->Form->input('img_name', array('label' => false, 'type' => 'hidden', 'id'=>'img_name', 'value' => '', 'name' => 'img_name')); ?>
...
<!--            <td>
    ...
    <div style="height:505px;width:100%;padding:5px;clear:both;">
        <div class="form_content" align="center">
                ...
                <div class="table-responsive"> 
                    <table class="table" id="rostertable" style="border-collapse:collapse;">
                        ...
                        <tr> 
                            ...
                            <td class="col-xs-1"><input  type="submit" name="submit" id="roster_fwd_eo" value="Forward" class="btn btn-sm logbutton2"></td>
            ...
            <div class="table-responsive"  style="margin-top:5px;" id="main_table">
                <table class="table table_extract" border="0" style="width:75%;">
                    <thead>
                        <tr>
                            ...
                            <th class="col-xs-3" colspan="3">Total Vacant Staff</th>
                    ...
                    <tbody>
                        ...
                        <tr class="Subjectdtl total_col" id="<?php //echo $post['SubjectTaught']['id'];                                                                                                                                                                                                     ?>">
                            ...
                            <td class="col-xs-3" colspan="3"><?php echo $this->Form->input('sanc_sum', array('label' => false, 'autocomplete' => 'off', 'type' => 'text', 'maxlength' => '50', 'style' => 'width:40% !important; text-transform: uppercase;text-align:center;')); ?></td>
                            <td class="col-xs-3" colspan="3"><?php echo $this->Form->input('wrk_sum', array('label' => false, 'autocomplete' => 'off', 'type' => 'text', 'maxlength' => '50', 'style' => 'width:40% !important; text-transform: uppercase;text-align:center;')); ?></td>
                            <td class="col-xs-3" colspan="3"><?php // echo $this->Form->input('vacnt_sum', array('label' => false, 'autocomplete' => 'off', 'type' => 'text', 'maxlength' => '50', 'style' => 'width:50% !important; text-transform: uppercase;text-align:center;'));                          ?></td>
                        </tr>
                    </tbody>
                </table>  
            </div>	
