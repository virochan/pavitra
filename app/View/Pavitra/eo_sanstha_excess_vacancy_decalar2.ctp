...
<style>
    #fieldset_style{border:1px solid #4A80D9;border-radius:7px;margin-top:5px;}
    #legend_title{text-align: center;width: 23%;background: rgb(62, 92, 154) none repeat scroll 0% 0%;color: rgb(255, 255, 255);padding: 5px 20px;border-radius:10px;margin-top: -7px;}
/*    #excess_vacancy_detail_tbl thead {width:97%}*/
    #excess_vacancy_detail_tbl thead tr th{min-height:60px;border:1px solid #BECDED;}
    #excess_vacancy_detail_tbl tbody tr td{border:1px solid #86A1DB;}
...
<!--    <table class="table" style="border-collapse:collapse;width:100%;">
    ...
    <div>
        <fieldset class="myfieldset" style="width:100%;border:1px solid #7B99D7;margin: 10px auto;">
            <legend><div id="legend_title" style="width:15%"><?php echo __('Vacancy Details'); ?></div>
            </legend>
                                        ...
                                        <table class="table table-fixed" id="excess_vacancy_detail_tbl">
                                            ...
                                            <th class="col-xs-5" colspan="5"><?php echo __('School Name'); ?></th>
                                            <th class="col-xs-1" ><?php echo __('Post'); ?></th>
                ...
                <table class="table" border="0" id="fieldtable" width="100%">
                    ...
                    <tr> 
                        ...
                        <td class="col-xs-5" colspan="5">   
                            <div id="schoolName">
                                <?php
                                echo $this->Form->input('schl_name', array('label' => '', 'type' => 'text', 'id' => 'schl_name', 'style' => 'width:410px', 'readonly' => 'readonly'));
                                ?>
                            </div>
                        </td>
                        <td class="col-xs-1">
...
<!--                    <tr style="background: #3E5C9A;border-top:1px solid #3B6394 !important;color:#fff;"> 
                ...
                <fieldset id="fieldset_style">
                    <legend>
                        <div id="legend_title"> School-wise Vacancy Positions</div></legend>
                <div>
                    <table class="table">
...
//        if (delete_btn_id == '') {
            ...
            if (Alphapattern.test(no_of_excess_vancant_posts) == false) {
                ...
                flag = 0;
                $('#no_of_excess_vancant_posts').val('');
                str = "\n Enter No. (Excess/Vacant) of Posts.";
            }
