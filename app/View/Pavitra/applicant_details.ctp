...
<div>
    ...
    <table
        <tr>
            ...
            <td><input  type="submit" name="Update" id="Update" value="<?php echo __('Update'); ?>" class="btn btn-sm logbutton2"></td>
            <td class="col-xs-1"><input  type="button" name="Exit" id="Exit" value="<?php echo __('Exit'); ?>" class="btn btn-sm logbutton2"></td>
        </tr>
    </table>
    <div>
        <fieldset class="myfieldset">
            <legend><div class="legend_title"><?php echo __('Personal Details'); ?></div></legend>
            <div class="table-responsive fielddata">
                <table class="table" id="fieldtable">
                    <tr>
                        ...
                        <td class="col-xs-2" colspan="2">
                            <?php echo __('Applicant Name') ?><span style="float:right;">:&nbsp;&nbsp;&nbsp;</span>
                        </td>
                        <td class="col-xs-2" colspan="2">
                            <input type="text" name="pv_apptn_fname" id="pv_apptn_fname" value="<?php echo trim($qry[0][0]['pv_apptn_fname']); ?>" style="text-transform:uppercase" placeholder="First Name" readonly/>
                        </td>
                        <td class="col-xs-2" colspan="2">
                            <input type="text" name="pv_apptn_mname" id="pv_apptn_mname" value="<?php echo trim($qry[0][0]['pv_apptn_mname']); ?>" style="text-transform:uppercase" placeholder="Middle Name" readonly/>
                        </td>
                        <td class="col-xs-2" colspan="2">
                            <input type="text" name="pv_apptn_lname" id="pv_apptn_lname" value="<?php echo trim($qry[0][0]['pv_apptn_lname']); ?>" style="text-transform:uppercase" placeholder="Last Name" readonly/>                           
                        </td>
                        <!--<td class="col-xs-2" colspan="3"> <?php //echo trim($qry[0][0]['pv_apptn_fname']) . ' ' . trim($qry[0][0]['pv_apptn_mname']) . ' ' . trim($qry[0][0]['pv_apptn_lname']);  ?></td>-->
                    </tr> 
                    ...
                    <tr>
                        ...
                        <td class="col-xs-4" colspan="4">
                            <div style="float:left;">
                                ...
                                <label id="1"><?php echo __('Male'); ?></label>
                            </div>
                            <div style="float:left;margin-left: 20px;">
                                <input type="radio" name="gen" id="cont_emp_2" value="2" <?php if ($qry[0][0]['pv_apptn_gen'] == 2) { ?> checked<?php } ?> readonly>
                                <label id="2"><?php echo __('Female'); ?></label>
                            </div>
                            <div style="float:left;margin-left: 20px;">
                                <input type="radio" name="gen" id="cont_emp_3" value="3" <?php if ($qry[0][0]['pv_apptn_gen'] == 3) { ?> checked<?php } ?> readonly>
                                <label id="3"><?php echo __('Transgender'); ?></label>
                            </div>
                        </td>
...
//                            date("d-m-Y", strtotime($qry[0][0]['pv_apptn_dob']));
                            ?>" class="inputBox" placeholder="DD-MM-YYYY" style = "width: 100% !important;" readonly>
                        </td>
                        <td class="col-xs-2" colspan="2">
                    ...
                    <tr>
                        ...
                        <td class="col-xs-2" colspan="2">
                            ...
                            echo $this->Form->input('medium', array('options' => $meds, 'id' => 'medium', 'label' => false, 'empty' => '-- Select Medium--', 'style' => 'width:100% !important; float: left;', 'value' => $medium));
                            ?>
                        </td>
                        <td class="col-xs-2" colspan="2">
                        ...
                        <td class="col-xs-2" colspan="2">
                            ...
                            echo $this->Form->input('categ', array('options' => $all_cast_type, 'id' => 'categ', 'label' => false, 'empty' => '-- Select Category--', 'style' => 'width:100% !important; float: left;', 'value' => $CT));
                            ?>
                        </td>
                        <td class="col-xs-2" colspan="2">
                        ...
                        <td class="col-xs-2" colspan="2">
                            ...
                            echo $this->Form->input('ph', array('options' => $all_ph_type, 'id' => 'ph', 'label' => false, 'empty' => '-- Select Disability Type--', 'style' => 'width:100% !important; float: left;', 'value' => $ph));
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-xs-2" colspan="2">
                            <?php if (!empty($qry[0][0]['pv_apptn_parttime'])) { ?>
                                <div style="float:left;">
                                    ...
                                    <label id="1"><?php echo __('Yes'); ?></label>
                                </div>
                                <div style="float:left;margin-left: 20px;">
                                    ...
                                    <label id="2"><?php echo __('No'); ?></label>
                                </div>
                            <?php } else { ?>
                                <div style="float:left;">
    ...
    <div>
        <fieldset class="myfieldset">
            <legend><div class="legend_title"> <?php echo __('Other Details'); ?></div></legend>
            <div class="table-responsive fielddata">
                <table class="table b_table" id="fieldtable">
                    <tr>
                        ...
                        <td class="col-xs-1" colspan="1"></td>
                    </tr>
                    <tr>
                        <td class="col-xs-2" colspan="2">
                    ...
                    <tr>
                        ...
                        <td class="col-xs-3" colspan="3">
                            <?php if (!empty($qry[0][0]['pv_border'])) { ?>
                                <div style="float:left;">
                                    <input type="radio" name="pr_border" id="pr_border_1" value="Y" <?php if (trim($qry[0][0]['pv_border']) == 'Y') { ?> checked<?php } ?>>
                                    <label id="1"><?php echo __('Yes'); ?></label>
                                </div>
                                <div style="float:left;margin-left: 20px;">
                                    <input type="radio" name="pr_border" id="pr_border_2" value="N" <?php if (trim($qry[0][0]['pv_border']) == 'N') { ?> checked<?php } ?>  >
                                    <label id="2"><?php echo __('No'); ?></label>
                                </div>
                            <?php } else { ?>
                                <div style="float:left;">
                                    <input type="radio" name="pr_border" id="pr_border_1" value="Y">
                                    <label id="1"><?php echo __('Yes'); ?></label>
                                </div>
                                <div style="float:left;margin-left: 20px;">
                                    <input type="radio" name="pr_border" id="pr_border_2" value="N" checked>
                                    <label id="2"><?php echo __('No'); ?></label>
                                </div>
                            <?php } ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="col-xs-5" colspan="5"></td>
                    </tr>
                    <tr>
                        <td class="col-xs-4" colspan="4">
                            <?php echo __('Select District For Document Verification in Case of Mismatch in TET and TAIT Data') ?><span style="float:right;">:&nbsp;&nbsp;&nbsp;</span>
                        </td>
                        <td class="col-xs-3" colspan="3">
                            <?php
...
//            var pr_domicile = $("input[name='pr_domicile']:checked").val();
            ...
            var dist_code = $('#dist_code :selected').val();
            ...
            if (schoolMobile.length < 10)
            {
                ...
                alert("Select Special (Horizontal) category.");
                return false;
            }
            else if (dist_code == "") {
                                        ...
                                        $("#pr_apptn_aadhar_3").keydown(function(e) {
                                            ...
                                            if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                                                    // Allow: Ctrl/cmd+A
                                                        ...
                                                        if (gen == 1) {
                                                            $("#cont_emp_2").prop('disabled', true);
                                                            $("#cont_emp_3").prop('disabled', true);
                                                        }
                                                        if (gen == 2) {
                                                            $("#cont_emp_1").prop('disabled', true);
                                                            $("#cont_emp_3").prop('disabled', true);
                                                        }
                                                        if (gen == 3) {
                                                            $("#cont_emp_1").prop('disabled', true);
...
//                                            });
                                            ...
                                            var mar = $("input[name='pr_apptn_mas']:checked").val();
                                            if (mar == 'M') {
                                                var checkflag = $('#app_no_of_chil').val();
                                                if (checkflag > 2) {
                                                    alert("Please enter valid Aadhar Number.");
                                                    $('#app_no_of_chil').val('');
                                                    $('#app_no_of_chil').focus();
                                                }
                                            }
                                            if (mar == 'N') {
                                                $('#app_no_of_chil').attr('readonly', true);
                                            } else {
                                                $('#app_no_of_chil').attr('readonly', false);
                                            }
                                            $("input[name=pr_apptn_mas]").on("change", function() {
                                                var mar = $("input[name='pr_apptn_mas']:checked").val();
                                                if (mar == 'M') {
                                                    $('#app_no_of_chil').attr('readonly', false);
                                                } else {
                                                    $('#app_no_of_chil').val(0);
                                                    $('#app_no_of_chil').attr('readonly', true);
                                                }
                                            });
