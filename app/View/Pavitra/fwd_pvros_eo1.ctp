...
//                $('#SamayojanVacntSum').val(p_sum);
        ...
        $('#pv_rostersans_fwdSancSum').val('0');
        $('#pv_rostersans_fwdWrkSum').val('0');
...
//            alert(price_val);
            if (price_val == 0) {
                ...
                $('#pv_rostersans_fwdSancSum').val(p_sum);
                $('.vcnt').each(function () {
                    if ($(this).val() != '') {
        ...
        $(".work").change(function () {
            ...
            if (work_val > price_val) {
                ...
                if (price_val == '0') {
                    ...
                    $('#pv_rostersans_fwdWrkSum').val(w_sum);
                    ...
                    $.each(val, function (key, val) {
                        $.each(val, function (key, val) {
                            $.each(val, function (key, val) {
                                ...
                                if (key === 'asst_flag') {
                                    if (val === 'F') {
                                        alert("Roster data already forwarded");
...
<?php echo $this->Form->create('pv_rostersans_fwd', array('url' => array('controller' => 'Pavitras', 'action' => 'forward_roster'))); ?>
...
<div style="height:505px;width:100%;padding:5px;clear:both;">
    <div class="form_content" align="center">
        <div class="map_head" style="min-height:115px;height:auto">
            <h3> Forward Roster Data </h3>
            <div class="table-responsive"> 
                <table class="table" id="rostertable" style="border-collapse:collapse;">
                    <tr>
                    ...
                    <tr> 
                        ...
                        <td class="col-xs-1"><input  type="submit" name="submit" id="roster_fwd_eo" value="Forward" class="gobutton" style="float:left;margin-right:1px;"></td>
                        <td class="col-xs-1"><input  type="button" name="cancel" id="roster_cancel" value="Cancel" class="gobutton" style="float:left;margin-right:1px;"></td>
                        <td class="col-xs-1"><input  type="button" name="caste_hm_exit" id="caste_hm_exit" value="Exit" class="gobutton" style="float:left;margin-right:1px;">
        ...
        <div class="table-responsive"  style="margin-top:5px;">
            <table class="table table_grid" border="0" style="width:70%; background:#fff">
                <tr class="tr_grid">
                    <td class="th_grid col-xs-1" style=""><div align="center" class="clorclas">Sr. No</div></td>
                    <td class="th_grid col-xs-2"><div align="center" class="clorclas">Category Name</div> </td>
                    <td class="th_grid col-xs-3" style=""> <div align="center" class="clorclas">Sanctioned post to be filled as per roster</div> </td>
                    <td class="th_grid col-xs-3"><div align="center" class="clorclas">Total Working Saff <br/>(Approved by EO / Dy. Director )</div></td>
                    <td class="th_grid col-xs-3"><div align="center" class="clorclas">Total Vacant Staff</div></td>
                ...
                <tr style="cursor: pointer;" class="tr_grid Subjectdtl" id="<?php //echo $post['SubjectTaught']['id'];                                                                                                                                                                                                    ?>">
                    <td  style="text-align:center" class="td_grid col-xs-1">2</td>
                ...
                <tr style="cursor: pointer;" class="tr_grid Subjectdtl" id="<?php //echo $post['SubjectTaught']['id'];                                                                                                                                                                                                    ?>">
                    <td class="td_grid col-xs-1"  style="text-align:center">6</td>
