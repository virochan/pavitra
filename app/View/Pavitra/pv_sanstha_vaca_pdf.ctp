        ...
        for ($j = 0; $j < count($check); $j++) {
            ...
            if($j==0){
               ...
               $html.='
                ...
                $html.='
                <td class="col-xs-5" colspan="5" valign="middle" style="font-family:arial;width:25%;font-size:13.5px">' . $name . '</td>
                ...
                <td class="col-xs-1" colspan="1" align="center" style="font-family:arial;width:8.5%;font-size:15px">' . $check[$j]['0']['shifted_tchr_cnt'] . '</td>
                <td class="col-xs-1" colspan="1" align="center" style="font-family:arial;width:11.5%;font-size:15px">' . $check[$j]['0']['shifted_tchr_cnt'] . '</td>
            </tr>';
