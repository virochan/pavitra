...
<style>
    .select_type{float:left;color:#000 !important;}
...
<!--    <table class="table" style="border-collapse:collapse;width:100%;">
    ...
    <div>
        <fieldset class="myfieldset2" style="width:100%;border:1px solid #7B99D7;margin: 10px auto;">
            <legend><div class="legend_title"><?php echo __('Vacancy Details'); ?></div>
            </legend>
                                ...
                                <div class="fixed-table-container">
                                    ...
                                    <div class="fixed-table-container-inner">    
                                        ...
                                        <table class="table" id="excess_vacancy_detail_tbl">
                                            ...
                                            <th class="th_grid col-xs-1" colspan="1"><div class="th-inner"><?php echo __('No.of Posts'); ?></div> </th>
...
<!--                                                <tr>
        ...
        <div class="table-responsive fielddata">
            <table class="table b_table" border="0" id="fieldtable" width="100%">
                <tr> 
                ...
                <tr>
<!--                    <td class="col-xs-2" colspan="2">Sanction Posts<span style="float:right;font-weight:bold;">:</span></td> -->
                    <td class="col-xs-2" colspan="2">SM Posts<span style="float:right;font-weight:bold;">:</span></td>
                    <td class="col-xs-1" colspan="1">

                        <?php
                        echo $this->Form->input('sanch_total', array('label' => ' ', 'type' => 'text', 'id' => 'sanch_total', 'value' => '', 'style' => 'width:65%!important;text-align:center;', 'readonly' => 'readonly', 'maxlength' => '3'));
                        ?>
                    </td>
...
<!--                        <td class="col-xs-3" colspan="3"> 
                    ...
                    <td class="col-xs-1">Working Posts<span style="float:right;font-weight:bold;">:</span></td>

                    <td class="col-xs-1" colspan="1"><?php echo $this->Form->input('eos_online_posts', array('label' => '', 'type' => 'text', 'id' => 'eos_online_posts', 'value' => '0', 'style' => 'width:65% !important;text-align:center;', 'maxlength' => '3')); ?></td>
                    ...
                    <?php echo $this->Form->input('filled_no_of_excess_vancant_posts_hidden', array('id' => 'filled_no_of_excess_vancant_posts_hidden', 'value' => '', 'type' => 'hidden', 'readonly' => 'readonly', 'maxlength' => '3')); ?>

                    <td class="col-xs-2" colspan="2">Post filled by Samayojan<span style="float:right;font-weight:bold;">:</span></td>
                    <td class="col-xs-1" colspan="1"><?php echo $this->Form->input('post_filld_smj', array('label' => '', 'type' => 'text', 'id' => 'post_filld_smj', 'style' => 'width:65% !important;text-align:center;', 'maxlength' => '3', 'readonly' => 'readonly')); ?></td>

                    <td class="col-xs-2" colspan="2">
                        <span>Vacancy after samayojan <b style="float:right;">:</b></span>
                    </td> 
                    <td class="col-xs-1"> 
                        <?php
                        echo $this->Form->input('excess_vacant_cal_posts', array('label' => ' ', 'type' => 'text', 'id' => 'excess_vacant_cal_posts', 'value' => '', 'style' => 'width:65%!important;float:left;margin-left:1%;', 'readonly' => 'readonly', 'maxlength' => '3'));
                        ?>
                    </td>
                </tr>
                <tr>
                    <td class="col-xs-4" colspan="4">Vacancy created during(1st Oct 2017 to 31st Dec 2017)<span style="float:right;font-weight:bold;">:</span></td>
                    <td class="col-xs-1" colspan="1"><?php echo $this->Form->input('vac_cr_during', array('label' => '', 'type' => 'text', 'id' => 'vac_cr_during', 'style' => 'width:65% !important;text-align:center;', 'maxlength' => '3', 'value' => 0)); ?></td>

                    <td class="col-xs-2" colspan="2">
                        <span>Total vacant Posts <b style="float:right;">:</b></span>
                    </td> 
                    <td class="col-xs-1"> 
                        <?php
                        echo $this->Form->input('total_vac_posts', array('label' => ' ', 'type' => 'text', 'id' => 'total_vac_posts', 'value' => '', 'style' => 'width:65%!important;float:left;margin-left:1%;', 'readonly' => 'readonly', 'maxlength' => '3'));
                        ?>
                    </td>
<!--                    <td class="col-xs-4" colspan="4">

                        <span>(Sanctioned-(Working+Post filled by Samayojan))</span>

                    </td> -->
                </tr>
<!--                    <tr>
                    <td class="col-xs-3" colspan="3">Working Posts<span style="float:right;font-weight:bold;">:</span></td>
...
<!--                        <td class="col-xs-5" colspan="5"> 
        ...
        <fieldset class="myfieldset2" style="width:100%;border:1px solid #7B99D7;margin: 10px auto;background: linear-gradient(to bottom, #ffffff 0%,#f3f3f3 100%);">
            <legend style="height:118px;"><div class="legend_title"><?php echo __('Vacancy Details'); ?></div>
                <div class="table-responsive">
                    <table class="table select_type b_table">
                        <tr>
                            <td class="col-xs-2" colspan="2" style="padding-left: 5%;">  
                                <?php echo __('Select Aid Type '); ?>   <span style="float:right;font-weight:bold">:</span>
                            </td>
                            <td class="col-xs-5" colspan="5">
                                <span>
...
<!--                            <td class="col-xs-2" colspan="2" style="padding-left: 3%;">Staff Type <span style="float:right;font-weight:bold">:</span></td>
                            <td class="col-xs-3" colspan="3">
                                <div style="float:left;">
                                    <input type="radio" name="staff_level" id="tchr_type1" value="1" >
                                    <label id="1">Part Time</label>
                        ...
                        <tr>
                            <td class="col-xs-2" colspan="2" style="padding-left: 5%;">  <?php echo __('Select Subject '); ?>   <span style="float:right;font-weight:bold">:</span></td>
                            <td class="col-xs-5" colspan="5">
                                <span>
                                    <?php
                                    echo $this->Form->input('option_subject_code', array('options' => $all_sama_sub_cat, 'label' => false, 'empty' => '-- Select Subject--',
                            ...
                            <td class="col-xs-2" colspan="2" style="padding-left:3%"> 
                                Enter No. of Posts   <span style="float:right;font-weight:bold">:</span>
                            </td>
...
//            alert(schcode);
                                ...
                                $('#school_medium_code').on('change', function() {
                                    ...
                                    if (school_medium_code != "") {
                                        if (dist_cd != "") {
                                            if (option_schl_type == '01' || option_schl_type == '02') {
                                                var school_medium_code = $('#school_medium_code :selected').val();
                                                jQuery.post('SelectSchoolPostsForSanstha', {schcode: schcode, school_medium_code: school_medium_code, option_schl_type: option_schl_type}, function(data) {
        ...
        $('#save_excess_vacancy_detail').on('click', function(e) {
            ...
            if (flag == 1) {
                ...
                var excess_vacant_cal_posts = $('#total_vac_posts').val();
                var option_subject_code = $('#option_subject_code :selected').val();
                var vac_cr_during = $('#vac_cr_during').val();
                ...
                var total_vac_posts = $('#total_vac_posts').val();
                ...
                jQuery.post('save_excess_vacancy_detail', {
                    ...
                    vac_cr_during: vac_cr_during,
                    total_vac_posts: total_vac_posts
                }, function(data) {
                    var enteredPost = 0;
                    var counter = 1;
                    $.each(jQuery.parseJSON(data), function(i, obj) {
                        if (i == 'filled_data' && obj == '1') {
                            alert("Can not enter more than assinged post");
                            location.reload();
                        } else {
...
//                            <input name="delete_btn" class="btn btn-sm logbutton2" type=button onclick="delete_btn_click(this)" value=Delete id=' + tr_id + '>
                                counter++;
                                enteredPost = ((parseInt(enteredPost)) + parseInt(val['0']['eos_no_of_post']));
                            });
                        }
                        if (i == 'duplicate') {
                        ...
                        if (i == 'mistmatch_data') {
                            alert("Vacancy Should not be greater than roster Vancacy.");
                            location.reload();
                        }
                    });
                    $('#excess_vacancy_detail_tbl tbody').html('');
