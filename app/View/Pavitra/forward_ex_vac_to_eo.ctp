...
<table border="0" style="border-collapse:collapse;width:100%;height:40px;">
    <tr>
        <td class="mapheading col-xs-9" colspan="9"  style="text-align:center;">Forward Sansthawise Vacancy Details to EO</td>




        <td class="col-xs-1"><?php echo $this->Form->submit('Forward To EO', array('class' => 'btn btn-sm logbutton2', 'id' => 'forward_eo_common', 'type' => 'submit', 'value' => 'Forward')); ?></td>
        <td class="col-xs-1"> <input class="btn btn-sm logbutton2 rstbtn"  id="cancel_tch_personal" type="button" value="Cancel"  /></td>
        <td class="col-xs-1"> <input class="btn btn-sm logbutton2"  id="exit_tch" type="button" value="Exit" /></td>
    </tr>
</table>
        ...
        <td class="col-xs-4" colspan="4">
            <div id="dist_school_help" style="padding-left:10%;">
                ...
                echo $this->Form->input('dist_id_school_help', array('options' => $district_list, 'empty' => '-- Select District --',
                    'id' => 'dist_id_school_help', 'label' => 'District &nbsp;:&nbsp; ', 'style' => 'width:250px;',
                    'class' => 'selectbox'));
                ?>
            </div>
        </td>
            ...
            <div id="school_list">
                ...
                if (!empty($school_list)) {
                    echo $this->Form->input('dist_id_school_help', array('options' => $school_list, 'empty' => '-- Select school --',
                        'id' => 'school_list', 'label' => 'Select School &nbsp;:&nbsp;', 'style' => 'width:250px;',
                        'class' => 'selectbox'));
                }
                ?>
            </div>
            <div id="desig_list">
                ...
                if (!empty($desig_list)) {
                    echo $this->Form->input('desig_cd', array('options' => $desig_list, 'empty' => '-- Select Designation --',
                        'id' => 'desig_cd', 'label' => 'Select Designation &nbsp;:&nbsp;', 'style' => 'width:250px;',
                        'class' => 'selectbox'));
                }
                ?>
            </div>
            <div id="med_list">
                ...
                if (!empty($med_list)) {
                    echo $this->Form->input('med_cd', array('options' => $med_list, 'empty' => '-- Select Medium --',
                        'id' => 'med_cd', 'label' => 'Select Medium &nbsp;:&nbsp;', 'style' => 'width:250px;',
                        'class' => 'selectbox'));
                }
                ?>
            </div>
            ...
            <div id="school_list">
                ...
                if (!empty($schools)) {
                    echo $this->Form->input('sch_cd', array('options' => $schools, 'empty' => '-- Select School --',
                        'id' => 'sch_cd', 'label' => 'Select School &nbsp;:&nbsp;', 'style' => 'width:250px;',
                        'class' => 'selectbox'));
                }
                ?>
            </div>
