...
<!--<li> <?php // echo $this->Html->link('Address', array('action' => 'address'));  ?></li>-->       
                                        ...
                                        <!--                                        <li> <?php echo $this->Html->link('Logout', array("controller" => 'Users',
                    "action" => "index"));
?>
                                                                                </li>  -->

                                        <li><?php echo $this->Html->link('Cluster Head', array('action' => 'ch_cluster')); ?>
                                            <ul class="sub-menu">
                                                <li> 
                                                    <?php echo $this->Html->link('PH Details ', array('action' => 'ph_cluster')); ?>
                                                </li> 
