                                    ...
                                    <ul class="nav">
                                        ...
                                        <li class="current-item"><?php echo $this->Html->link('Reports', array('action' => '')); ?>
                                            <ul>
                                              ...
                                              <li><?php echo $this->Html->link('Statistical Report', array('action' => 'st_report')); ?></li>
                                              <li><?php echo $this->Html->link('Demo Statistical Report', array('action' => 'demo_st_report')); ?></li>
                                                 <li><?php echo $this->Html->link('RDD Interstate Statistics', array('action' => 'rdd_interstate_stat')); ?></li>
                                                
                                            </ul>
                                        </li>
                                        <li><?php echo $this->Html->link('Dashboard', array("controller" => 'Teachers', "action" => "dashboard")); ?></li>
