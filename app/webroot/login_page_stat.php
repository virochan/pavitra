...
from (
select roster_edn_level,exv.sanstha_code,
CASE
WHEN roster_edn_level = 'P' and asst_flag = 'E' ::bpchar THEN count(1)
ELSE 0::bigint
...
from samayojan.roster_info exv
LEFT JOIN samayojan.sanstha_basic_info sd ON exv.sanstha_code=sd.sanstha_code and sd.sanstha_code='1'
group by roster_edn_level,asst_flag,exv.sanstha_code
UNION
select roster_edn_level,exv.sanstha_code,
...
CASE
WHEN roster_edn_level = 'S' and asst_flag = 'E' ::bpchar THEN count(1)
ELSE 0::bigint
...
from samayojan.roster_info  exv
LEFT JOIN samayojan.sanstha_basic_info sd ON exv.sanstha_code=sd.sanstha_code and sd.sanstha_code='1'
group by roster_edn_level,asst_flag,exv.sanstha_code) temp 
