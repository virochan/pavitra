...
// by : hemant kadam   
  $(document).ready(function () {
     ...
     //var TechrState = $('#acad_qualificationTechrState').val();
...
//                                            });
                                            ...
                                            if (val < 10) {
                                             ...
                                             if (val2 == 27){
                                                jQuery('#acad_qualificationRadioGroup1').prop('checked', true);
                                            } else {
                                                jQuery('#acad_qualificationRadioGroup2').prop('checked', true);
                                            }
        ...
        $(document.body).on('click', '#save_prof_dtl', function() {
            // alert("inside submit");
         var AcadQual = $('#acad_qualificationSelectedAcadQual').val();
         var TechrExam = $('#acad_qualificationTechrExam').val();
         var TechrCollage = $('#acad_qualificationTechrCollage').val();
