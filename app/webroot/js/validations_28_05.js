...
//        else if (dateToCompare_curr_desig_dt < dateToCompare_serv_entry_dt) {
        else if ((daydiff(parseDate($('#tchr_curr_desig_dt').val()), parseDate($('#tchr_serv_entry_dt').val()))) > 0) {
            flag = 0;
            $("#tchr_curr_desig_dt").focus();
            str = "\n Err... Invalid Date of Joining in Current Designation.";
        }
...
//            var YearDiffSen = nowYear - pastYear; //Year Difference of 2 dates
            ...
            var tchr_serv_entry_dt1 = $('#tchr_serv_entry_dt_post').val();
            var date1 = tchr_serv_entry_dt1.substring(0, 2);
            var month1 = tchr_serv_entry_dt1.substring(3, 5);
            var year1 = tchr_serv_entry_dt1.substring(6, 10);
            var age = 12;
            var dateToCompare_serv_entry_dt1 = new Date();
            dateToCompare_serv_entry_dt1.setFullYear(year1, month1 - 1, date1);
            var setDate = new Date();
            setDate.setFullYear(dateToCompare_serv_entry_dt1.getFullYear() + age, month1 - 1, date1);

            var tp_sen_grade_scale_dt1 = $('#tp_sen_grade_scale_dt').val(); //Date of Entry in Service 
            var date = tp_sen_grade_scale_dt1.substring(0, 2);
            var month = tp_sen_grade_scale_dt1.substring(3, 5);
            var year = tp_sen_grade_scale_dt1.substring(6, 10);
            var dateToCompare_sen_grade_scale_dt1 = new Date();
            dateToCompare_sen_grade_scale_dt1.setFullYear(year, month - 1, date);
...
//            else if (YearDiffSen > 12) {
            else if ((dateToCompare_sen_grade_scale_dt1 - setDate) < 0) {
//            alert("INVALIDDDD");
                flag = 0;
//                $("#tp_sen_grade_scale_dt").focus();
                str = "\n Err... Please Enter Valid Received Senior Grade Scale Date.";
